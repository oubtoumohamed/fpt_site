...
@section('content')
  ...
  <form class="card" method="POST" enctype="multipart/form-data" action="@if($object->id){{ route('slider_update',$object->id) }}@else{{ route('slider_store') }}@endif">
    {{ csrf_field() }}
    <div class="card-body">
      <h3 class="card-title">
        @if($object->id)
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-contro" id="image" name="image" type="file">
          </div>
        </div>
